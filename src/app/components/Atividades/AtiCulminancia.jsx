...
const AtiCulminancia = () => {
  return (
    <div className='bg-gradient-to-tl from-blue-100 to-white py-8'>
        <div className="flex flex-col max-w-7xl mx-auto md:flex-row items-center justify-center sm:p-8">
        
            <div className="md:w-1/2 md:ml-4">
                <h2 className="mb-4 text-4xl text-slate-900 font-semibold px-8 ">A Culminância</h2>
                <p className='text-slate-900 px-8 pb-8'>
        ...
        <div className='max-w-md sm:max-w-3xl border-3 border-primary m-4 p-4 mx-auto rounded-xl'>
            <p className='text-slate-900 m-4 p-4'>Para o evento de culminância o educador deve marcar, junto com os estudantes e com a gestão da escola, uma data para apresentar os resultados do projeto para o público a ser escolhido: outros professores, outras turmas, a comunidade do bairro, entre outros.</p>
        </div>
